...
export const databaseLoader = new ResourceLoader<Database>({
  async load() {
    ...
    // RUN BELOW COMMAND ON SUPA SQL CONNECTION URI
    // Deno stopped IPv4 in Jan 2025 so this part stays broken
    // temp fix is to create schema by self and let it run normally
...
// END SQL PART © github.com/pr13260 for fun 
//`);
    //await client.end();
